...
<script type="text/javascript">
    ...
    $(function () {
        ...
        datatable = $('#datatable').DataTable({
            ajax: {
                url: "${basePath}/sw/receivingRecords/seeList",
                type: "post",
                data: function (d) {
    ...
    {title: 'id', data: "id",visible:false},
            ...
            render: function (data) {
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        return ' <@shiro.hasPermission name="sw:receivingRecords:see">'
        ...
        $(document).on("click", ".seeBtn", function () {
            ...
            top.krt.layer.openDialogView("标题:  " + title + "  来文单位： " + receivedOrg, "${basePath}/sw/receivingRecords/see?id=" + id,"1400px","850px");
        })
