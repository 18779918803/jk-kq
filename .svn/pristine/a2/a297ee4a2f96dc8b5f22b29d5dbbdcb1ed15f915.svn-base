            ...
            if (StringUtils.isNotBlank(assignee)) {
                ...
                if (!CollectionUtils.isEmpty(todoUserIdList)) {
                    for (String todoUserId : todoUserIdList) {
                        ...
                        newItem.setTodoUserId(user.getId().toString());  //表示的是登录名字
                    ...
                    if (!CollectionUtils.isEmpty(userList)) {
                        for (String todoUserId : userList) {
                            ...
                            User user = userService.selectById(todoUserId);
                            newItem.setTodoUserId(user.getId().toString());  //表示的是用户名
