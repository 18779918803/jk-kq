        ...
        <option value="">==请选择==</option>
            <@dic type="sw_received_org" ; dicList>
                <#list dicList as item>
                    <option value="${item.code}" ${((receivingRecords.receivedOrg==item.code?eval)?string("selected",""))!}>${item.name}</option>
                </#list>
            </@dic>
    </select>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <div id="instructions" class="col-sm-10">
                        <#--  <textarea rows="4" id="instructions" class="form-control" readonly></textarea>  -->
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <select class="form-control select2" style="width: 100%" id="editable" name="editable" required>
                            <option value="">==请选择==</option>
                                <@dic type="sys_is_not" ; dicList>
                                    <#list dicList as item>
                                        <option value="${item.code}" ${((receivingRecords.editable==item.code?eval)?string("selected",""))!}>${item.name}</option>
                                    </#list>
                                </@dic>
                        </select>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-10">
<@krt.editor  name="text" value="${receivingRecords.text!}" validate=''></@krt.editor>
                </div>
            </div>
        </div>
    </div>
