            ...
            render: function (data) {
                ...
                {title: "董事长意见",data: "presidentAdvice"},
                {
                    ...
                    "render": function (data, type, row) {
                        var res = "";
                         res+= '<@shiro.hasPermission name="dbDelay:dbDelay:delete">'
                            ...
                            +'<i class="fa fa-share-square-o fa-btn"></i> 导出延期（撤销）申请表'
                            + '</button>'
                            + '</@shiro.hasPermission>';
                        if (row.instanceId) {
                            res+= '<@shiro.hasPermission name="dbDelay:dbDelay:commited">'
                            ...
                            res+= '<@shiro.hasPermission name="dbDelay:dbDelay:commit">'
