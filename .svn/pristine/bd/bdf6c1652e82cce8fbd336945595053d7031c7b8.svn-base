                    ...
                    <form role="form" class="form-horizontal krt-form" id="krtForm">
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="deviceId" name="deviceId"
                                                   value="${jkClock.deviceId!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <!-- 参数 -->
                                            <input type="hidden" name="organId" id="organId" value="${(jkClock.organ_id)!}" class="form-control">
                                            <div class="input-group">
                                                <input type="text" name="organ" value="${(jkClock.organ)!}" id="organ" readonly class="form-control">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group input-group-addon-right-radius">
                                                <input type="text" class="form-control pull-right" name="punchTime"
                                                       id="punchTime"
                                                       value="${(jkClock.punchTime?string("yyyy-MM-dd HH:mm:ss"))!}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="punchState"
                                                ...
                                                <option value="1" ${((jkClock.punchState== 1)?string("selected",""))!}>成功</option>
                                                <option value="0" ${((jkClock.punchState== 0)?string("selected",""))!}>失败</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- 隐藏域 -->
                                <input type="hidden" name="id" id="id" value="${jkClock.id!}">
                            </div>
                        </div>
                    </form>
                </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/kq/jkClock/update",
