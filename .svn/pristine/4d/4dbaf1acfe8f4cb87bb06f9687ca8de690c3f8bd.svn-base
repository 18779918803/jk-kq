                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="name" name="name" value="${writeoffRecord.name!}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" name="organId" id="organId"
                                                   value="${(writeoffRecord.organ_id)!}" class="form-control">
                                            <div class="input-group">
                                                <input type="text" name="organ" value="${(writeoffRecord.organ)!}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pname" class="control-label col-sm-4">
                                            <span class="form-required">*</span>核销原因：
                                        </label>
                                        <div class="col-sm-8">
                                            <textarea rows="2" name="reason" class="form-control"
                                                      required>${writeoffRecord.reason!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="state"
                                                ...
                                                <option ${((writeoffRecord.state==0)?string("selected",""))!} value="0">审核中</option>
                                                <option ${((writeoffRecord.state==1)?string("selected",""))!} value="1">审批通过</option>
                                                <option ${((writeoffRecord.state==-1)?string("selected",""))!} value="-1">审批拒绝</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pname" class="control-label col-sm-4">
                                            <span class="form-required">*</span>核销类型：
                                        </label>
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="typeId"
                                                    name="typeId" required>
                                                <#list writeoffTypes as item>
                                                    <option value="${item.id}" ${((writeoffRecord.typeId==item.id)?string("selected",""))!}>${item.name}</option>
                                                </#list>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <!-- 隐藏域 -->
                            <input type="hidden" name="id" id="id" value="${writeoffRecord.id!}">
                            <input type="hidden" name="openUserId" id="openUserId"
                                   value="${writeoffRecord.openUserId!}">
                        </div>
                    </form>
                </div>
            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/kq/writeoffRecord/update",
