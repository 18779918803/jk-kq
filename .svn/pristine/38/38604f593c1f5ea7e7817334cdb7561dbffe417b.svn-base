...
public class SendUtil {
    ...
    public void getGZHOpenUserId() throws UnsupportedEncodingException {
        ...
        if (!ObjectUtils.isEmpty(user) && !ObjectUtils.isEmpty(user.getNextOpenid())){
            url = "https://api.weixin.qq.com/cgi-bin/user/get?access_token=" + WxPushServiceImpl.ACCESS_TOKEN + "next_openid=" + user.getNextOpenid();
        }else {
            url = "https://api.weixin.qq.com/cgi-bin/user/get?access_token=" + WxPushServiceImpl.ACCESS_TOKEN;
        }
          ...
          //获取所有用户列表的接口
            ...
            for (String openid : openIds) {
                //获取单个用户信息的微信的接口
                String getOpenUserInfoUrl = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=" + WxPushServiceImpl.ACCESS_TOKEN + "&openid=" + openid;
