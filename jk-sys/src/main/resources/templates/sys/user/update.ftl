...
<#--                                <div class="col-sm-12">-->
<#--                                    <div class="form-group">-->
<#--                                        <label for="auth" class="control-label col-sm-4">类别：</label>-->
<#--                                        <div class="col-sm-6">-->
<#--                                            <div class="input-group">-->
<#--                                                    <input type="radio" name="auth" id="auth" value="审批通过" > 审核通过-->
<#--                                                    <input type="radio" name="auth"  id="auth" value="审批不通过" > 审核不通过-->
<#--                                            </div>-->
<#--                                            </div>-->
<#--                                        </div>-->
<#--                                    </div>-->
...
<#--                                    <div class="col-sm-12">-->
<#--                                        <div class="form-group">-->
<#--                                            <label for="auth" class="control-label col-sm-4">审核方式：</label>-->
<#--                                            <div class="col-sm-6">-->
<#--                                                <div class="input-group">-->
<#--                                                    <input type="radio" checked  name="auth" id="auth" value="${user.auth}" > ${user.auth}-->
<#--                                                </div>-->
<#--                                            </div>-->
<#--                                        </div>-->
<#--                                    </div>-->
