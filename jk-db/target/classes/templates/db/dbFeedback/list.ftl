    ...
    {title: 'id', data: "id",visible:false},
            ...
            render: function (data) {
                ...
                {title: "董事长意见",data: "presidentAdvice"},
                {
                    ...
                    "render": function (data, type, row) {
                        var res = "";
                         res +=' <@shiro.hasPermission name="feedback:dbFeedback:update">'
                            ...
                            +'<i class="fa fa-share-square-o fa-btn"></i> 导出办结反馈表'
                            + '</button>'
                            + '</@shiro.hasPermission>';
                        if (row.instanceId) {
                            res += '<@shiro.hasPermission name="feedback:dbFeedback:commited">'
        ...
        $(document).on("click", ".commitBtn", function () {
            ...
            krt.layer.confirm("确认要提交申请吗？", function () {
                krt.ajax({
                    type: "POST",
                    url: "${basePath}/db/dbFeedback/submitApply",
                    data: {"id": id},
                    success: function (rb) {
