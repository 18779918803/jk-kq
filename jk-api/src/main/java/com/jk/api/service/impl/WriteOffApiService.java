...
public class WriteOffApiService {
     ...
     */
    @Transactional
    public Integer addWriteOff(User user, WriteoffRecordDTO dto,int id)   {
        int writeoff = apiService.selectRole(user.getRoles());
        ...
        writeoffRecordService.submitApply(convertor, user.getName(), "writeoff", map);
