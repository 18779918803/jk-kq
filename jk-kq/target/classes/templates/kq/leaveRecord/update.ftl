                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="name" name="name" value="${leaveRecord.name!}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" name="organId" id="organId"
                                                   value="${(leaveRecord.organ_id)!}" class="form-control">
                                            <div class="input-group">
                                                <input type="text" name="organ" value="${(leaveRecord.organ)!}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pname" class="control-label col-sm-4">
                                            <span class="form-required">*</span>请假原因：
                                        </label>
                                        <div class="col-sm-8">
                                            <textarea rows="2" name="reason" class="form-control"
                                                      required>${leaveRecord.reason!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="day" name="day" value="${leaveRecord.day!}"
                                                   class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="state"
                                                ...
                                                <option ${((leaveRecord.state==0)?string("selected",""))!} value="0">审核中</option>
                                                <option ${((leaveRecord.state==1)?string("selected",""))!} value="1">审批通过</option>
                                                <option ${((leaveRecord.state==-1)?string("selected",""))!} value="-1">审批拒绝</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pname" class="control-label col-sm-4">
                                            <span class="form-required">*</span>请假类型：
                                        </label>
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="typeId"
                                                    name="typeId" required>
                                                    <#list leaveTypes as item>
                                                        <option value="${item.id}" ${((leaveRecord.typeId==item.id)?string("selected",""))!}>${item.name}</option>
                                                    </#list>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <!-- 隐藏域 -->
                                <input type="hidden" name="id" id="id" value="${leaveRecord.id!}">
                                <input type="hidden" name="openUserId" id="openUserId"
                                       value="${leaveRecord.openUserId!}">
                            </div>
                    </form>
                </div>
            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/kq/leaveRecord/update",
