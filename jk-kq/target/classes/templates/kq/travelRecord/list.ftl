                        ...
                        <div class="row row-search">
                            <div class="col-xs-12">
                                <form class="form-inline" action="">
                                    ...
                                    <div class="form-group">
                                        <label for="date" class="control-label ">出差日期:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="day" class="control-label ">出差天数:</label>
                                        <input type="text" id="day" name="day" placeholder="出差天数" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="typeId" class="control-label ">出差类型:</label>
                                        <div class="form-group">
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="table-toolbar" id="table-toolbar">
                                <@shiro.hasPermission name="TravelRecord:travelRecord:insert">
                                ...
                                <@shiro.hasPermission name="TravelRecord:travelRecord:delete">
                                    <button class="btn btn-sm btn-danger" id="deleteBatchBtn">
                                        <i class="fa fa-trash fa-btn"></i>批量删除
                                    </button>
                                </@shiro.hasPermission>
                                <@shiro.hasPermission name="TravelRecord:travelRecord:excelOut">
                                    <@krt.excelOut id="excelOutBtn" url="${basePath}/kq/travelRecord/excelOut"></@krt.excelOut>
                                </@shiro.hasPermission>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            datatable = $('#datatable').DataTable({
                ajax: {
                    url: "${basePath}/kq/travelRecord/list",
                    type: "post",
                    data: function (d) {
                        d.name = $("#name").val();
                        d.organId = organId;
                ...
                columns: [
                    ...
                    {title: "出差日期", data: "date"},
                    {title: "出差原因", data: "reason"},
                    {title: "出差天数", data: "day"},
                    {title: "申请状态", data: "state"},
                    {title: "出差类型", data: "typeName"},
                    {title: "申请提交时间", data: "insertTime"},
                    {
                        title: "操作", data: "id", orderable: false,
                        "render": function (data, type, row) {
                            return ' <@shiro.hasPermission name="TravelRecord:travelRecord:update">'
            ...
            $("#insertBtn").click(function () {
                top.krt.layer.openDialog("新增出差申请", "${basePath}/kq/travelRecord/insert", "1000px", "500px");
            });

            //修改
            $(document).on("click", ".updateBtn", function () {
                var id = $(this).attr("rid");
                top.krt.layer.openDialog("修改出差申请", "${basePath}/kq/travelRecord/update?id=" + id, "1000px", "500px");
            });
            ...
            $(document).on("click", ".deleteBtn", function () {
                ...
                krt.layer.confirm("你确定删除吗？", function () {
                    krt.ajax({
                        type: "POST",
                        url: "${basePath}/kq/travelRecord/delete",
                        data: {"id": id},
                        success: function (rb) {
                            krt.layer.msg(rb.msg);
                            if (rb.code == 200) {
            ...
            $("#deleteBatchBtn").click(function () {
                ...
                if (ids == "") {
                    ...
                    krt.layer.confirm("你确定删除吗？", function () {
                        krt.ajax({
                            type: "POST",
                            url: "${basePath}/kq/travelRecord/deleteByIds",
                            data: {"ids": ids},
                            success: function (rb) {
                                krt.layer.msg(rb.msg);
                                if (rb.code == 200) {
