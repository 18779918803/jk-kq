                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="rom" name="rom" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="space" name="space" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="app" name="app" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="fingerprint" name="fingerprint" class="form-control"
                                                   required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="face" name="face" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="headpic" name="headpic" class="form-control"
                                                   required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="clockin" name="clockin" class="form-control"
                                                   required>
                                        </div>
                                    </div>
                                </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/kq/deviceInfo/insert",
