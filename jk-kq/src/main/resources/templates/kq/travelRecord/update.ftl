                    ...
                    <form role="form" class="form-horizontal krt-form" id="krtForm">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="name" name="name" value="${travelRecord.name!}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" name="organId" id="organId"
                                                   value="${(travelRecord.organ_id)!}" class="form-control">
                                            <div class="input-group">
                                                <input type="text" name="organ" value="${(travelRecord.organ)!}"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group input-group-addon-right-radius">
                                                <input type="text" class="form-control pull-right" name="date" id="date"
                                                       value="${(travelRecord.date?string("yyyy-MM-dd HH:mm:ss"))!}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea rows="2" name="reason" class="form-control"
                                                      required>${travelRecord.reason!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="day" name="day" value="${travelRecord.day!}"
                                                   class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="state"
                                                ...
                                                <option ${((travelRecord.state==0)?string("selected",""))!} value="0">审核中</option>
                                                <option ${((travelRecord.state==1)?string("selected",""))!} value="1">审批通过</option>
                                                <option ${((travelRecord.state==-1)?string("selected",""))!} value="-1">审批拒绝</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="typeId"
                                                ...
                                                <#list travelTypes as item>
                                                    <option value="${item.id}" ${((travelRecord.typeId==item.id)?string("selected",""))!}>${item.name}</option>
                                                </#list>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <!-- 隐藏域 -->
                                <input type="hidden" name="id" id="id" value="${travelRecord.id!}">
                                <input type="hidden" name="openUserId" id="openUserId"
                                       value="${travelRecord.openUserId!}">
                            </div>
                    </form>
                </div>
            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/kq/travelRecord/update",
