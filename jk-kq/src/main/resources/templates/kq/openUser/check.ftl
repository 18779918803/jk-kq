    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            datatable = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            return ' <@shiro.hasPermission name="OpenUser:openUser:update">'
                                + '<button class="btn btn-xs btn-primary checkBtn" rid="' + row.id + '" state="1">'
                                + '<i class="fa fa-check fa-btn"></i>通过'
                                + '</button>'
                                + '</@shiro.hasPermission>'
                                + '<@shiro.hasPermission name="OpenUser:openUser:update">'
                                + '<button class="btn btn-xs btn-warning checkBtn" rid="' + row.id + '" state="-1">'
                                + '<i class="fa fa-circle-o-notch fa-btn"></i>拒绝'
                                + '</button>'
                                + '</@shiro.hasPermission>';
                        }
                    }
            ...
            $(document).on("click", ".checkBtn", function () {
                ...
                krt.layer.confirm("你确定"+str+"吗？", function () {
                    krt.ajax({
                        type: "POST",
