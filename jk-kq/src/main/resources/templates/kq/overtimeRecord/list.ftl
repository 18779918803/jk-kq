                        ...
                        <div class="row row-search">
                            <div class="col-xs-12">
                                <form class="form-inline" action="">
                                    ...
                                    <div class="form-group">
                                        <label for="date" class="control-label ">加班日期:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="day" class="control-label ">加班天数:</label>
                                        <input type="text" id="day" name="day" placeholder="加班天数" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="typeId" class="control-label ">加班类型:</label>
                                        <div class="form-group">
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="table-toolbar" id="table-toolbar">
                                <@shiro.hasPermission name="OvertimeRecord:overtimeRecord:insert">
                                ...
                                <@shiro.hasPermission name="OvertimeRecord:overtimeRecord:delete">
                                    <button class="btn btn-sm btn-danger" id="deleteBatchBtn">
                                        <i class="fa fa-trash fa-btn"></i>批量删除
                                    </button>
                                </@shiro.hasPermission>
                                <@shiro.hasPermission name="OvertimeRecord:overtimeRecord:excelOut">
                                    <@krt.excelOut id="excelOutBtn" url="${basePath}/kq/overtimeRecord/excelOut"></@krt.excelOut>
                                </@shiro.hasPermission>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            datatable = $('#datatable').DataTable({
                ajax: {
                    url: "${basePath}/kq/overtimeRecord/list",
                    type: "post",
                    data: function (d) {
                        d.name = $("#name").val();
                        d.organId = organId;
                ...
                columns: [
                    ...
                    {title: "加班日期", data: "date"},
                    {title: "加班原因", data: "reason"},
                    {title: "加班天数", data: "day"},
                    {title: "加班类型", data: "typeName"},
                    {title: "申请提交时间", data: "insertTime"},
                    {
                        title: "操作", data: "id", orderable: false,
                        "render": function (data, type, row) {
                            return ' <@shiro.hasPermission name="OvertimeRecord:overtimeRecord:update">'
            ...
            $("#insertBtn").click(function () {
                top.krt.layer.openDialog("新增加班申请", "${basePath}/kq/overtimeRecord/insert", "1000px", "500px");
            });

            //修改
            $(document).on("click", ".updateBtn", function () {
                var id = $(this).attr("rid");
                top.krt.layer.openDialog("修改加班申请", "${basePath}/kq/overtimeRecord/update?id=" + id, "1000px", "500px");
            });
            ...
            $(document).on("click", ".deleteBtn", function () {
                ...
                krt.layer.confirm("你确定删除吗？", function () {
                    krt.ajax({
                        type: "POST",
                        url: "${basePath}/kq/overtimeRecord/delete",
                        data: {"id": id},
                        success: function (rb) {
                            krt.layer.msg(rb.msg);
                            if (rb.code == 200) {
            ...
            $("#deleteBatchBtn").click(function () {
                ...
                if (ids == "") {
                    ...
                    krt.layer.confirm("你确定删除吗？", function () {
                        krt.ajax({
                            type: "POST",
                            url: "${basePath}/kq/overtimeRecord/deleteByIds",
                            data: {"ids": ids},
                            success: function (rb) {
                                krt.layer.msg(rb.msg);
                                if (rb.code == 200) {
