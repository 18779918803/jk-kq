                        ...
                        <div class="row row-search">
                            <div class="col-xs-12">
                                <form class="form-inline" action="">
                                    ...
                                    <div class="form-group">
                                        <label for="date" class="control-label ">核销日期:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="typeId" class="control-label ">核销类型:</label>
                                        <div class="form-group">
                                            <select class="form-control select2" style="width: 100%" id="typeId"
                                                    name="typeId">
                                                <option value="">==请选择==</option>
                                                <#list writeoffTypes as item>
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="table-toolbar" id="table-toolbar">
                                <@shiro.hasPermission name="WriteoffRecord:writeoffRecord:insert">
                                ...
                                <@shiro.hasPermission name="WriteoffRecord:writeoffRecord:delete">
                                    <button class="btn btn-sm btn-danger" id="deleteBatchBtn">
                                        <i class="fa fa-trash fa-btn"></i>批量删除
                                    </button>
                                </@shiro.hasPermission>
                                <@shiro.hasPermission name="WriteoffRecord:writeoffRecord:excelOut">
                                    <@krt.excelOut id="excelOutBtn" url="${basePath}/kq/writeoffRecord/excelOut"></@krt.excelOut>
                                </@shiro.hasPermission>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            datatable = $('#datatable').DataTable({
                ajax: {
                    url: "${basePath}/kq/writeoffRecord/list",
                    type: "post",
                    data: function (d) {
                        d.name = $("#name").val();
                        d.organId = organId;
                ...
                columns: [
                    ...
                    {title: "核销日期", data: "date"},
                    {title: "核销原因", data: "reason"},
                    {title: "申请状态", data: "state"},
                    {title: "核销类型", data: "typeName"},
                    {title: "申请提交时间", data: "insertTime"},
                    {
                        title: "操作", data: "id", orderable: false,
                        "render": function (data, type, row) {
                            return ' <@shiro.hasPermission name="WriteoffRecord:writeoffRecord:update">'
            ...
            $("#insertBtn").click(function () {
                top.krt.layer.openDialog("新增核销申请", "${basePath}/kq/writeoffRecord/insert", "1000px", "500px");
            });

            //修改
            $(document).on("click", ".updateBtn", function () {
                var id = $(this).attr("rid");
                top.krt.layer.openDialog("修改核销申请", "${basePath}/kq/writeoffRecord/update?id=" + id, "1000px", "500px");
            });
            ...
            $(document).on("click", ".deleteBtn", function () {
                ...
                krt.layer.confirm("你确定删除吗？", function () {
                    krt.ajax({
                        type: "POST",
                        url: "${basePath}/kq/writeoffRecord/delete",
                        data: {"id": id},
                        success: function (rb) {
                            krt.layer.msg(rb.msg);
                            if (rb.code == 200) {
            ...
            $("#deleteBatchBtn").click(function () {
                ...
                if (ids == "") {
                    ...
                    krt.layer.confirm("你确定删除吗？", function () {
                        krt.ajax({
                            type: "POST",
                            url: "${basePath}/kq/writeoffRecord/deleteByIds",
                            data: {"ids": ids},
                            success: function (rb) {
                                krt.layer.msg(rb.msg);
                                if (rb.code == 200) {
